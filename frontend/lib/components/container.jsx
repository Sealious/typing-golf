			...
			<div className="main-column">
				<div className="logo-item">
					<a href="#/" title="go to home">
						<span className="logo animated flipInX">
							typing·golf
						</span>
					</a>
				</div>
				<div className="nav">
					<div className="nav-item">
						<Link
							...
							to="tasks"
							activeClassName="active"
							title="show a list of all available tasks"
						>
							tasks
						</Link>
					</div>
				...
				/>
				<div className="cheatsheet-box" onClick={this.coverCheatsheet}>
					?
				</div>
			</div>
		);
